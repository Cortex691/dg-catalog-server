...
const addKomercijalista = async (req, res) => {
...
const getKomercijaliste = async (req, res) => {
  try {
...
const editKomercijalista = async (req, res) => {
...
const deleteKomercijalsita = async (req, res) => {
...
const addObjekat = async (req, res) => {
...
const editObjekat = async (req, res) => {
...
const deleteObjekat = async (req, res) => {
...
const changeOrderActivity = async (req, res) => {
